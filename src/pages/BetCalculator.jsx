    ...
    >
      ...
      >
        <div className="flex justify-between items-center mb-8">
           ...
           <button onClick={() => setIsGuideOpen(false)} className="p-2 hover:bg-white/5 rounded-full text-white/40"><Trash2 size={20} /></button>
        </div>
